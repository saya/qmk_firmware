...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* -                                                                                                      ' " */
      ...
      KC_ENTER,   KC_Z, LSFT_X, LGUI_C,  RSYM_D,   KC_V, _______, _______, _______, _______, KC_K,   LNUM_H, LGUI_COMM, RSFT_DOT, KC_SLSH, KC_ENTER,
               XXXXXXX, RSFT_INS, KC_ESC, NAV_SPC, KC_TAB, KC_ENT, SFT_BSPC,   FUN_DEL, RSFT_INS, XXXXXXX
    ),
    [_L_NUM] = LAYOUT(
            /*  %      ,                   # */
      ...
      _______,   KC_EQL, KC_4, KC_5,   KC_6, KC_ASTR,  _______, _______, _______, _______, KC_COLN, _______,
            /*    @                          + */
      _______,    KC_AT, KC_1, KC_2,   KC_3, KC_PLUS,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
               _______, _______, KC_0, KC_SPC, _______,  _______, _______, _______, _______, _______
    ),
    [_L_FUN] = LAYOUT(
    ...
    [_R_SYM] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,   KC_DLR,  KC_EQL, KC_LPRN, KC_RPRN,  KC_GRV, _______,
                                                                                              /* ~      , !      , [      , ]      , \        */
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_TILD, KC_EXLM, KC_LBRC, KC_RBRC, KC_BSLS, _______,
    ...
    [_R_NAV] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, KC_END , KC_PGDN, KC_PGUP, _______, _______,
               _______, _______, _______, _______, _______,   _______, _______,  _______, _______, _______
    )
};
